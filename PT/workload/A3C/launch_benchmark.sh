    ...
    if [ "$run_perf" == "1" ];then
        ...
        do
            ...
            printf "numactl --localalloc --physcpubind ${cpu_array[i]} \
                    timeout 3600  python main.py --env-name "PongDeterministic-v4" \
                                                 --ipex \
...
function collect_logs {
    ...
    echo "${period}; ${model_}; ${precision}; ${model_name}; ${throughput}; ${compute_op_time}" | tee -a ${WORKSPACE}/summary.log
}
