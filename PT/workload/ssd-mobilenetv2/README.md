...
```
ln -s /home2/pytorch-broad-models/ssd-vgg16/model/mb2-ssd-lite-mp-0_686.pth ./models/mb2-ssd-lite-mp-0_686.pth
...
```bash
python -u eval_ssd.py --net mb2-ssd-lite \
...
'''
Throughput is: 16.312060 imgs/s
'''
