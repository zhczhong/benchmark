    ...
    if [ "$run_perf" == "1" ];then
        ...
        do
            ...
            printf "numactl --localalloc --physcpubind ${cpu_array[i]} \
                    timeout 3600  python benchmark.py --model-path /home2/pytorch-broad-models/TTS/models/tacotron2/best_model.pth.tar \
                                --config-path=/home2/pytorch-broad-models/TTS/models/tacotron2/config.json \
                                --ipex \
                                --precision ${precision} \
                                --dataset-name=ljspeech \
                                --metadata-path=/home2/pytorch-broad-models/TTS/datasets/ljspeech/truncated_metadata.csv \
