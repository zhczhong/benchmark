...
cd ../../pytorch-ssd
git apply ${PATCH_DIR}/ssd-vgg16.patch
pip install pandas opencv-python

# prepare model and dataset
ln -s ${pytorch_pretrain_dir}/ssd-vgg16/model/vgg16-ssd-mp-0_7726.pth ./models/vgg16-ssd-mp-0_7726.pth
