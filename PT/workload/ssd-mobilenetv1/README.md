...
```
cd PT/pytorch-ssd
git apply ../workload/ssd-mobilenetv1/ssd-mobilenetv1.patch
```
...
```
ln -s /home2/pytorch-broad-models/ssd-vgg16/model/mobilenet-v1-ssd-mp-0_675.pth ./models/mobilenet-v1-ssd-mp-0_675.pth
...
```bash
python -u eval_ssd.py --net mb1-ssd \
...
'''
Throughput is: 24.891137 imgs/s
'''
