...
cd ../../mlperf_training
git apply ${PATCH_DIR}/deepspeech.patch
cd ./speech_recognition/pytorch

ln -s ${pytorch_pretrain_dir}/DeepSpeech2/models ./models
ln -s ${pytorch_pretrain_dir}/DeepSpeech2/LibriSpeech_dataset ./dataset
...
cp ${PATCH_DIR}/libri_val_manifest.csv ../
