...
function init_params {
    ...
    framework='pytorch'
    model='transformer_lt_inference'
...
function generate_core {
    ...
    do
        ...
        printf " OMP_NUM_THREADS=${real_cores_per_instance} numactl --localalloc --physcpubind ${cpu_array[i]} \
            fairseq-generate data-bin/iwslt14.tokenized.de-en --path ./data-bin/checkpoint_best.pt --batch-size 1 \
            --beam 5 --remove-bpe --cpu --ipex --dnnl \
