...
cd ../../wide_deep
cp ${PATCH_DIR}/inference_arch1_binary.py .
git apply ../workload/wide_deep/wide_deep.patch
pip install -e .

# prepare model and dataset
ln -s ${pytorch_pretrain_dir}/widedeep/data data
ln -s ${pytorch_pretrain_dir}/widedeep/model model
