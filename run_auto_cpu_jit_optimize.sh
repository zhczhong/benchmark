...
# onednn acceptance and stock pt nightly model list
model_all="resnet50,resnet34,resnext101_32x16d,mobilenet_v2,shufflenet_v2_x1_0,vgg11,fasterrcnn_resnet50_fpn"
