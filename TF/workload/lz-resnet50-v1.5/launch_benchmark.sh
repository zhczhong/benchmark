...
function main {
    ...
    if [ "${precision}" == "float32" ];then
        precision="fp32"
        input_graph=/home2/tensorflow-broad-product/oob_tf_models/intel-models/tf_dataset/pre-trained-models/resnet50v1_5/fp32/resnet50_v1.pb
    elif [ "${precision}" == "int8" ];then
        input_graph=/home2/tensorflow-broad-product/oob_tf_models/intel-models/tf_dataset/pre-trained-models/resnet50v1_5/int8/bias_resnet50.pb
    else
        input_graph=/home2/tensorflow-broad-product/oob_tf_models/intel-models/tf_dataset/pre-trained-models/resnet50v1_5/bf16/bf16_resnet50_v1.pb
    fi
    #
...
function generate_core {
    ...
    do
        ...
        printf "numactl -m $(echo ${cpu_array[i]} |awk -F ';' '{print $2}') \
            ...
            python ./benchmarks/launch_benchmark.py --benchmark-only --framework tensorflow --model-name resnet50v1_5 \
                --mode inference --precision ${precision} --batch-size ${batch_size} \
