...
function prepare_workload {
    #
    workload_dir="${PWD}"
    rm -rf DCGAN-tensorflow
    git clone https://github.com/carpedm20/DCGAN-tensorflow.git
    cd DCGAN-tensorflow
    git reset --hard 62c9a2a
    patch -f -p1 < ${workload_dir}/dcgan.patch || true
...
function main {
    ...
    do
        ...
        python main.py --dataset mnist --input_height=28 --output_height=28 \
            --checkpoint_dir ${PWD}/checkpoint --data_dir ./data \
            --batch_size=1 --num_iter=2 --num_warmup=1 --test --precision ${precision}
        #
...
function generate_core {
    ...
    do
        ...
        printf "numactl -m $(echo ${cpu_array[i]} |awk -F ';' '{print $2}') \
            ...
            python main.py --dataset mnist --test --input_height=28 --output_height=28 \
                --checkpoint_dir ${PWD}/checkpoint --data_dir ./data \
