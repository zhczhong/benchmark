...
function prepare_workload {
    #
    workload_dir="${PWD}"
    if [ ! -e wide_deep_saved_models ];then
        ln -sf /home2/tensorflow-broad-product/oob_tf_models/mlp/WD/wide_deep_saved_models .
        ln -sf /home2/tensorflow-broad-product/oob_tf_models/mlp/WD/census_data .
    fi
}
