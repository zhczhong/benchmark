...
do
    numactl --cpunodebind=0 --membind=0 python main.py -e --performance --pretrained --dummy --no-cuda -j 1 -w 20 -i 100 -a $model -b 80 --precision "int8" --ipex 2>&1 | tee ./logs/$model-IPEX-INT8.log
